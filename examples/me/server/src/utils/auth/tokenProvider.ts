import type { TokenInfo } from '@commercetools/sdk-client-v2/src/types/sdk'
...
export default class TokenProvider {
  ...
  refreshTokenFlowPromise?: Promise<TokenInfo> | Promise<Object>
  ...
  static _isTokenProvided(tokenInfo: TokenInfo): boolean {
    return !!(tokenInfo && tokenInfo.access_token && tokenInfo.expires_at)
  }
