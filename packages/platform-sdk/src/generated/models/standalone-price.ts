...
export interface StandalonePrice extends BaseResource {
   ...
   *	When a [relative discount](/../api/projects/productDiscounts#relative) is applied and the fraction part of the `discounted` price is 0.5, the discounted price is rounded in favor of the customer with the [half down rounding](https://en.wikipedia.org/wiki/Rounding#Round_half_down).
   *
   *
   */
