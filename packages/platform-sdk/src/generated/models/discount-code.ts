...
export interface DiscountCode extends BaseResource {
  ...
  /**
   *	Array generated by the commercetools Platform from the Cart predicate.
  ...
  /**
   *	Used and managed by the commercetools Platform and must not be used in customer logic.
...
export interface DiscountCodeDraft {
  ...
  readonly code: string
  /**
   *	Specify the CartDiscounts the Platform applies when you add the DiscountCode to the Cart.
   *
   *
   */
