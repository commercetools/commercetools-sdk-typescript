...
/**
 **/
export class ByProjectKeyPaymentMethodsRequestBuilder {
  constructor(
  ...
  public withKey(childPathArgs: {
    key: string
  }): ByProjectKeyPaymentMethodsKeyByKeyRequestBuilder {
  ...
  public withId(childPathArgs: {
    ID: string
  }): ByProjectKeyPaymentMethodsByIDRequestBuilder {
  ...
  }): ApiRequest<PaymentMethodPagedQueryResponse> {
    return new ApiRequest<PaymentMethodPagedQueryResponse>(
      {
        baseUri: this.args.baseUri,
        method: 'GET',
