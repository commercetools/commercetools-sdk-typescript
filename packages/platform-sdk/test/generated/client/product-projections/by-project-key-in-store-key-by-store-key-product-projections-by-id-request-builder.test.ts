...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    {
      method: 'get',
      uri: '/test_projectKey/in-store/key=test_storeKey/product-projections/test_ID?priceCustomerGroupAssignments=priceCustomerGroupAssignments',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .productProjections()
    ...
    {
      method: 'get',
      uri: '/test_projectKey/in-store/key=test_storeKey/product-projections/test_ID?priceRecurrencePolicy=priceRecurrencePolicy',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .productProjections()
    ...
    {
      method: 'get',
      uri: '/test_projectKey/in-store/key=test_storeKey/product-projections/test_ID?filter%5Battributes%5D=filter%5Battributes%5D',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .productProjections()
