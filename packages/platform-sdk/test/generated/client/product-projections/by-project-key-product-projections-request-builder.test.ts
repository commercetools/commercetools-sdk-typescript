...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    {
      method: 'get',
      uri: '/test_projectKey/product-projections?priceCustomerGroupAssignments=priceCustomerGroupAssignments',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .productProjections()
        .get({
    ...
    {
      method: 'get',
      uri: '/test_projectKey/product-projections?priceRecurrencePolicy=priceRecurrencePolicy',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .productProjections()
    ...
    {
      method: 'get',
      uri: '/test_projectKey/product-projections?filter%5Battributes%5D=filter%5Battributes%5D',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .productProjections()
