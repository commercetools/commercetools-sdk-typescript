...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    {
      method: 'get',
      uri: '/test_projectKey/mcp-servers/test_ID',
      request: apiRoot
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/mcp-servers/test_ID?version=2',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .mcpServers()
        .withId({ ID: 'test_ID' })
...
describe('Testing ByProjectKeyMcpServersByIDRequestBuilder Requests', () => {
