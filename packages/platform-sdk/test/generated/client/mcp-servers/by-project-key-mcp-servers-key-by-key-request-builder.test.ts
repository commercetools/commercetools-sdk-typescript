...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    {
      method: 'get',
      uri: '/test_projectKey/mcp-servers/key=test_key',
      request: apiRoot
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/mcp-servers/key=test_key?version=2',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .mcpServers()
        .withKey({ key: 'test_key' })
...
describe('Testing ByProjectKeyMcpServersKeyByKeyRequestBuilder Requests', () => {
