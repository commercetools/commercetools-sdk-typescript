...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    {
      method: 'get',
      uri: '/test_projectKey/product-projections/test_ID/variant-attributes?filter%5BsupplyChannels%5D=filter%5BsupplyChannels%5D&filter[attributes]=filter%5Battributes%5D',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .productProjections()
        .withId({ ID: 'test_ID' })
...
describe('Testing ByProjectKeyProductProjectionsByIDVariantAttributesRequestBuilder Requests', () => {
