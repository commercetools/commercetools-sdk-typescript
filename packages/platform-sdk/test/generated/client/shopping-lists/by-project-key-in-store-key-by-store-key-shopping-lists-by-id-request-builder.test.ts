...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/shopping-lists/test_ID?dataErasure=true&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .shoppingLists()
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/shopping-lists/test_ID?expand=expand&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .shoppingLists()
