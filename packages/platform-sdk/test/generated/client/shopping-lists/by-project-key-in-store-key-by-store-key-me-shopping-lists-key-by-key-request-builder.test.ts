...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/me/shopping-lists/key=test_key?dataErasure=true&version=3',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .me()
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/me/shopping-lists/key=test_key?expand=expand&version=3',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .me()
