...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    {
      method: 'get',
      uri: '/test_projectKey/me/business-units/test_ID?expand=expand',
      request: apiRoot
    ...
    {
      method: 'get',
      uri: '/test_projectKey/me/business-units/test_ID',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .me()
        .businessUnits()
...
describe('Testing ByProjectKeyMeBusinessUnitsByIDRequestBuilder Requests', () => {
