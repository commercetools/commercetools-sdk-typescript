...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/customers/key=test_key?dataErasure=true&version=2',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .customers()
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/customers/key=test_key?expand=expand&version=2',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .customers()
