...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/customers/test_ID?dataErasure=true&version=7',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .customers()
    ...
    },
    {
      method: 'delete',
      uri:
        '/test_projectKey/in-store/key=test_storeKey/customers/test_ID?expand=expand&version=7',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .customers()
