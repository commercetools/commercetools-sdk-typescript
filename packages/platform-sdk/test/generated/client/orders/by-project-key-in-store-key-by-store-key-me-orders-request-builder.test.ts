...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    {
      method: 'get',
      uri: '/test_projectKey/in-store/key=test_storeKey/me/orders?expand=expand',
      request: apiRoot
    ...
    {
      method: 'get',
      uri: '/test_projectKey/in-store/key=test_storeKey/me/orders?withTotal=true',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .me()
    ...
    {
      method: 'get',
      uri: '/test_projectKey/in-store/key=test_storeKey/me/orders?var.varName=var.varName',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .me()
