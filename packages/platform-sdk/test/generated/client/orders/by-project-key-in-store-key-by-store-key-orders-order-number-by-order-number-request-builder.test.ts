...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/in-store/key=test_storeKey/orders/order-number=test_orderNumber?dataErasure=true&version=7',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .orders()
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/in-store/key=test_storeKey/orders/order-number=test_orderNumber?expand=expand&version=7',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .orders()
