...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    {
      method: 'get',
      uri: '/test_projectKey/recurrence-policies/key=test_key?expand=expand',
      request: apiRoot
    ...
    {
      method: 'get',
      uri: '/test_projectKey/recurrence-policies/key=test_key',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .recurrencePolicies()
        .withKey({ key: 'test_key' })
...
describe('Testing ByProjectKeyRecurrencePoliciesKeyByKeyRequestBuilder Requests', () => {
