...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    {
      method: 'get',
      uri: '/test_projectKey/recurring-orders/test_ID?expand=expand',
      request: apiRoot
    ...
    {
      method: 'get',
      uri: '/test_projectKey/recurring-orders/test_ID',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .recurringOrders()
        .withId({ ID: 'test_ID' })
...
describe('Testing ByProjectKeyRecurringOrdersByIDRequestBuilder Requests', () => {
