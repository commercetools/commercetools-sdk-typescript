...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/in-store/key=test_storeKey/cart-discounts/key=test_key?version=2',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .cartDiscounts()
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/in-store/key=test_storeKey/cart-discounts/key=test_key?expand=expand&version=2',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .inStoreKeyWithStoreKeyValue({ storeKey: 'test_storeKey' })
        .cartDiscounts()
...
describe('Testing ByProjectKeyInStoreKeyByStoreKeyCartDiscountsKeyByKeyRequestBuilder Requests', () => {
