...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/products/importSinkKey=test_importSinkKey/import-operations?sort=sort',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .products()
        .importSinkKeyWithImportSinkKeyValue({
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/products/importSinkKey=test_importSinkKey/import-operations?state=ValidationFailed',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .products()
        .importSinkKeyWithImportSinkKeyValue({
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/products/importSinkKey=test_importSinkKey/import-operations?debug=true',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .products()
        .importSinkKeyWithImportSinkKeyValue({
...
describe('Testing ByProjectKeyProductsImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder Requests', () => {
