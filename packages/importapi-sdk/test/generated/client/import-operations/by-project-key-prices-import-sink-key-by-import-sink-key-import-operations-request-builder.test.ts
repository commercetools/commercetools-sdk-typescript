...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/prices/importSinkKey=test_importSinkKey/import-operations?state=ValidationFailed',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .prices()
        .importSinkKeyWithImportSinkKeyValue({
...
describe('Testing ByProjectKeyPricesImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder Requests', () => {
