...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/product-variants/importSinkKey=test_importSinkKey/import-operations?state=ValidationFailed',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .productVariants()
        .importSinkKeyWithImportSinkKeyValue({
...
describe('Testing ByProjectKeyProductVariantsImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder Requests', () => {
