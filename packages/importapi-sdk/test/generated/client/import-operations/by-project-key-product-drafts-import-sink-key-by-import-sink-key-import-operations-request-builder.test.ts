...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/product-drafts/importSinkKey=test_importSinkKey/import-operations?state=ValidationFailed',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .productDrafts()
        .importSinkKeyWithImportSinkKeyValue({
...
describe('Testing ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder Requests', () => {
