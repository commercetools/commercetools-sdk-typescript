...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/product-types/importSinkKey=test_importSinkKey/import-operations?state=ValidationFailed',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .productTypes()
        .importSinkKeyWithImportSinkKeyValue({
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/product-types/importSinkKey=test_importSinkKey/import-operations?debug=true',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .productTypes()
        .importSinkKeyWithImportSinkKeyValue({
