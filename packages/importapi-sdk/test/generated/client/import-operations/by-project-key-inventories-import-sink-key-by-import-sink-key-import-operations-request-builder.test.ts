...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    },
    {
      method: 'get',
      uri:
        '/test_projectKey/inventories/importSinkKey=test_importSinkKey/import-operations?state=ValidationFailed',
      request: apiRoot
        .withProjectKeyValue({ projectKey: 'test_projectKey' })
        .inventories()
        .importSinkKeyWithImportSinkKeyValue({
...
describe('Testing ByProjectKeyInventoriesImportSinkKeyByImportSinkKeyImportOperationsRequestBuilder Requests', () => {
