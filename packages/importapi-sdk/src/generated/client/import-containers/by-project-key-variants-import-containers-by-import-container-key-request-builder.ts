...
/**
 **/
export class ByProjectKeyVariantsImportContainersByImportContainerKeyRequestBuilder {
  constructor(
    ...
    return new ApiRequest<ImportResponse>(
      {
        ...
        method: 'POST',
        uriTemplate:
          '/{projectKey}/variants/import-containers/{importContainerKey}',
