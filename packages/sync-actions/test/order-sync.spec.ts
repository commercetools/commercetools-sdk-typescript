...
import { actionGroups, createSyncOrders } from '../src/orders'
...
describe('Actions', () => {
  let orderSync = createSyncOrders()
  beforeEach(() => {
    orderSync = createSyncOrders()
  })

  describe('base', () => {
    test('should build *state actions', () => {
      const before: DeepPartial<Order> = {
        orderState: 'Open',
